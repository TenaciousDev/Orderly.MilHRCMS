    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Orderly.Data.ApplicationDbContext>
    {
        ...
        protected override void Seed(Orderly.Data.ApplicationDbContext context)
        {
            ...
            context.PersonnelDbSet.AddOrUpdate(x => x.PersonnelId,
                ...
                new Personnel() { PersonnelId = 23, Rank = Grade.W2, FirstName = "Adoree", LastName = "Minard", MiddleName = "Lorry", Sex = BioSex.Male, SSN = "501-13-8757", DOD = "8590210758", DOB = new DateTime(1987, 02, 29), MaritalStatus = MaritalStatus.Other },
                ...
                new Personnel() { PersonnelId = 122, Rank = Grade.E6, FirstName = "Broderick", LastName = "Vauter", MiddleName = "Antin", Sex = BioSex.Other, SSN = "604-37-0704", DOD = "2673033599", DOB = new DateTime(1976, 02, 29), MaritalStatus = MaritalStatus.NeverMarried },
                ...
                new Personnel() { PersonnelId = 124, Rank = Grade.E5, FirstName = "Shani", LastName = "Ralphs", MiddleName = "Deane", Sex = BioSex.Female, SSN = "472-42-2612", DOD = "8302159662", DOB = new DateTime(1998, 02, 29), MaritalStatus = MaritalStatus.Widowed },
